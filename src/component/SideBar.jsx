            ...
            {loading ? (
              ...
              <span className="app-brand-logo demo">
                ...
                >
                  ...
                  <g id="g-app-brand" stroke="none" fill="none">
                      ...
                      <g id="Icon" transform="translate(27.000000, 15.000000)">
                        ...
                        <ul className="menu-inner py-1">
                            ...
                            <li className="menu-header small text-uppercase">
                                <span className="menu-header-text">Gruhlar va sozlamalar</span>
                            </li>
                            <li className="menu-item" id={"menu-item"}>
                                <a onClick={openDrop} href="#" className="menu-link menu-toggle">
                                    <i className="menu-icon tf-icons bx bxs-group"></i>
                                    <div data-i18n="Account Settings">Mening gruhlarim</div>
                                </a>
                            ...
                            <li className="menu-item" id={"menu-item2"}>
                                <a href="#" onClick={openDrop2} className="menu-link menu-toggle">
                                    <i className="menu-icon tf-icons bx bx-cog"></i>
                                    <div data-i18n="Misc">Sozlamalar</div>
                                </a>
                                <ul className="menu-sub">
                                    <li className="menu-item">
                                        <a href="pages-misc-error.html" className="menu-link">
                                            <div data-i18n="Error">Shahsiy accountim</div>
                                        </a>
                                    </li>
                                    <li className="menu-item">
                            ...
                            <li className="menu-header small text-uppercase"><span
                                className="menu-header-text">Misc</span></li>
                            <li className="menu-item">
                                <a
